...
module.exports = (function () {
    ...
    let language = {
        ...
        fr: {
            ...
            "information": {
                "intro": "Si vous voulez aider, vous pouvez aider à traduire les langues suivantes:",
                "btn": "Aidez à traduire"
            },
            "thanks": {
        ...
        ar: {
            ...
            "information": {
                "intro": "Օգնեք մեզ թարգմանել մեր հավելվածը հետևյալ լեզուներով.",
                "btn": "Օգնել թարգմանել"
            },
            "thanks": {
        ...
        ru: {
            ...
            "information": {
                "intro": "Помогите нам перевести наше приложение на данные языки:",
                "btn": "Помогите нам перевести"
            },
            "thanks": {
                "intro": "Мы благодарим следующих людей за помощь в переводе:"
            }
        }
    };
